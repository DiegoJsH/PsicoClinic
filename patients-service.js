...
class PacienteService {
  ...
  static searchPacientesByNombre(nombre) {
    return this.request(
      `/pacientes/query?nombre=${encodeURIComponent(nombre)}`
    );
  }
}
...
function updateEstadisticas(pacientes) {
  ...
  document.getElementById("nuevosEsteMes").textContent =
    calcularNuevosEsteMes(pacientes);
}
            ...
            <tr>
                <td>
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="fw-semibold">${p.nombre} ${
        p.apellido
      }</div>
                ...
                <td>
                    <div class="btn-group btn-group-sm">
                        <button onclick="editPaciente(${
                          p.id
                        })" class="btn btn-outline-secondary" title="Editar">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <button onclick="deletePacienteById(${
                          p.id
...
async function guardarNuevoPaciente() {
  try {
    ...
    ["firstName", "lastName", "birthDate", "gender", "phone", "email"].forEach(
